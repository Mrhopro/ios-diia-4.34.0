        ...
        return [
            DSListItemViewModel(
                ...
                onClick: { [weak self] in
                    self?.view.open(module: NotificationsModule())
                })
        ]
    }
    ...
    func communicationSections() -> [DSListItemViewModel] {
        return [
            ...
            DSListItemViewModel(
                ...
                onClick: { [weak self] in
                    self?.view.open(module: FAQModule())
                })
        ]
    }
