...
final class FeedPresenter: FeedAction {
    ...
    func handleAction(actionModel: DSActionParameter) {
        ...
        case "militaryBonds":
            view.open(module: MilitaryBondsModule())
        case "failedConnection":
            view.open(module: OutageReportModule())
        case "invincibilityPoints":
            view.open(module: InvincibilityPointsModule())
        case "smartMobilization", "militaryDonation":
            view.open(module: SmartMobilizationModule())
        case "polls", "pollsList":
            view.open(module: PollsModule())
        case "privateEntrepreneur":
            view.open(module: FopTaxesModule())
        case "replacementDriverLicense":
            view.open(module: DriverLicenseReplacementModule())
        case "damagedProperty":
            view.open(module: DamagedPropertyModule())
        default:
            break
        }
    }
